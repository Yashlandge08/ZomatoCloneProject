...
<body>
 ...
 <div class="registration-container text-center yash">
        <h2 class="text-white mb-4">Register</h2>
        <a href="customer_registration.jsp" class="btn btn-primary custom-btn">Customer Registration</a>
        <a href="delivery_register.jsp" class="btn btn-success custom-btn">Delivery Registration</a>
    </div>
