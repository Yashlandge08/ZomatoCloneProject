...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
     <link rel="stylesheet" href="css/showhotel.css"> <!-- External CSS File -->
...
<body>
 ...
 <section><!--main section-->
      ...
      <nav class="navbar navbar-expand-lg bg-transperant fixed-top">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active text-white" aria-current="page" href="investorrelation.jsp">Investor Relation</a>
              </li>
              <li class="nav-item">
...
<div class="container mt-5 mb-5">
  ...
  <div class="row text-center">
    <div class="col-4 col-md-3 col-lg-2 round">
    <img src="./images/showhotel/pizza.webp" class="img-fluid" alt="">
    <p>Pizza</p>
  </div>
  <div class="col-4 col-md-3 col-lg-2">
    <img src="./images/showhotel/biryani.webp" class="img-fluid" alt="">
    <p>Biryani</p>
  </div>
  <div class="col-4 col-md-3 col-lg-2">
    <img src="./images/showhotel/chicken.webp" class="img-fluid" alt="">
    <p>Chicken</p>
  </div>
  <div class="col-4 col-md-3 col-lg-2">
    <img src="./images/showhotel/cake.webp" class="img-fluid" alt="">
    <p>Cake</p>
  </div>
  <div class="col-4 col-md-3 col-lg-2">
    <img src="./images/showhotel/rolls.webp" class="img-fluid" alt="">
    <p>Rolls</p>
  </div>
  <div class="col-4 col-md-3 col-lg-2">
    <img src="./images/showhotel/Thali.webp" class="img-fluid" alt="">
    <p>Thali</p>
  </div>
  </div>
</div>
...
<section>
  <div class="container mt-5 mb-5">
    <h1>Top Brand's For You</h1>
    <div class="row text-center">
      <div class="col-4 col-md-3 col-lg-2 round">
      <img src="./images/showhotel/mc donald.webp" class="img-fluid" alt="">
      <p>McDonald's</p>
    </div>
    <div class="col-4 col-md-3 col-lg-2">
      <img src="./images/showhotel/domino pizza.webp" class="img-fluid" alt="">
      <p>Domino's Pizza</p>
    </div>
    <div class="col-4 col-md-3 col-lg-2">
      <img src="./images/showhotel/kfc.webp" class="img-fluid" alt="">
      <p>KFC</p>
    </div>
    <div class="col-4 col-md-3 col-lg-2">
      <img src="./images/showhotel/rolls mania.webp" class="img-fluid" alt="">
      <p>Rolls Mania</p>
    </div>
    <div class="col-4 col-md-3 col-lg-2">
      <img src="./images/showhotel/burger king.png" class="img-fluid" alt="">
      <p>Burger King</p>
    </div>
    <div class="col-4 col-md-3 col-lg-2">
      <img src="./images/showhotel/pind punjabi.webp" class="img-fluid" alt="">
      <p>Pind Punjabi</p>
    </div>
    </div>
  </div>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="path/to/restaurant-image.jpg" class="card-img-top" alt="Restaurant Image"> <!-- Optional Image -->
                    <div class="card-body">
                        <h5 class="card-title"><%= restaurant.getName() %></h5>
                        <p class="card-text">
                            <strong>Contact:</strong> <%= restaurant.getContactNo() %><br>
                            <strong>Location:</strong> <%= restaurant.getStreet() %>, <%= restaurant.getCity() %> - <%= restaurant.getPincode() %>
                        </p>
                       <a href="RestaurantMenuServlet?restaurants_id=<%= restaurant.getId() %>">
    <button class="btn btn-primary btn">View Menu</button>
</a>
